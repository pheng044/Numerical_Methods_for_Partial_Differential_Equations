function [TRI, Nodes, DirichletNodes] = getDiscreteGeometry(Shape, DomainSize, ref, powerRef)
...
t1 = find(abs(Nodes(:,1) + XX) <1e-10);
t2 = find(abs(Nodes(:,1)-(XX+1)) <1e-10);

DirichletNodes = [t1; t2];
%===
% Figures
%===
